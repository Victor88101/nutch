...
public class TikaParser implements org.apache.nutch.parse.Parser {
  ...
  public Parse getParse(String url, WebPage page) {
	...
	final boolean useBoilerpipe = getConf().getBoolean("tika.use_boilerpipe", false);
	final boolean useBoilerpipeEstimator = getConf().getBoolean("tika.boilerpipe.use_estimator", false);
	final String boilerpipeExtractorName = getConf().get("tika.boilerpipe.extractor", "ArticleExtractor");
...
//   DOMBuilder domhandler = new DOMBuilder(doc, root);
	final ContentHandler domhandler;
	// Check whether to use Tika's BoilerplateContentHandler
	if (useBoilerpipe) {
		domhandler = new BoilerpipeContentHandler((ContentHandler) new DOMBuilder(doc, root),
